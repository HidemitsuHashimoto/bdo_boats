...
class ShipUpgrade {
  static List<String> list(String id) {
    return switch (id) {
      'veleiroBartali' => ['veleiroEpheria', 'fragataEpheria'],
      'veleiroEpheria' => ['navioMercanteEpheria'],
      'fragataEpheria' => ['contratorpedeiroEpheria'],
...
class _ShipDetailsState extends State<ShipDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    final shipUpgradeList = ShipUpgrade.list(ship.id);
